...
echo _gettext("Continue");
    ...
    {
        return new Source("", "database/structure/bulk_action_modal.twig", "/home3/fsrfnhte/management.retailstoresolution.com/db/templates/database/structure/bulk_action_modal.twig");
    }
}
