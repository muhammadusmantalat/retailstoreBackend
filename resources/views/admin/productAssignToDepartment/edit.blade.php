    ...
    <div class="main-content">
        <section class="section">
            <div class="section-body">
                ...
                <form id="edit_assignment" action="{{ route('products-departments-update', $storeManagerId) }}" method="POST"
            ...
            $('.delete-assignment').click(function() {
                ...
                if (confirm('Are you sure you want to delete this department?')) {
                    $.ajax({
                        ...
                        url: "/retailstore/admin/products-assignDepartments-delete", // Use a relative URL
                        // url:"{{ url('admin/vendors-assign-delete') }}",
                        data: {
                            'id': id,
                            'product_id': productId, // Include vendor_id in the request
                            'store_manager_id': storeManagerId,
                            'store_id': storeId // Include store_id in the request
                        },
                        success: function(data) {
                            toastr.success('Department Deleted Successfully!');
                            window.location.href =
                                "/retailstore/admin/products-departments/" +
                                storeManagerId + "/" + storeId + "/" + productId;
                        },
                    });
                }
            });
            ...
            $('.delete-assignment').click(function() {
                ...
                if (confirm('Are you sure you want to delete this department?')) {
                    $.ajax({
                        ...
                        url: "/Retail-Store-Management/admin/products-assignDepartments-delete", // Use a relative URL
                        // url:"{{ url('admin/vendors-assign-delete') }}",
                        data: {
                            'id': id,
                            'product_id': productId, // Include vendor_id in the request
