    ...
    <div class="main-content">
        <section class="section">
            <div class="section-body">
                ...
                <form id="add_department" action="{{ route('manager.storeManagerVendor-store') }}" method="POST"
                                ...
                                <div class="row mx-0 px-4">
                                    <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text" placeholder="Enter Wholesaler Name" name="wholesaler_name"
                                                id="wholesaler_name" value="{{ old('wholesaler_name') }}"
                                                class="form-control">
                                    ...
                                    <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="email" placeholder="Enter Wholesaler Email"
                                                name="wholesaler_email" id="wholesaler_email"
                                                value="{{ old('wholesaler_email') }}" class="form-control">
                                    ...
                                    <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="tel" placeholder="Enter Wholesaler Phone No"
                                                name="wholesaler_phone_number" id="wholesaler_phone_number"
                                                value="{{ old('wholesaler_phone_number') }}" class="form-control">
                                    ...
                                    <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="number" placeholder="Enter General Discount by Wholesaler"
                                                ...
                                                value="{{ old('general_discount') }}" class="form-control"
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <select class="form-control" name="order_frequency">
                                                <option value="" disabled
                                                    {{ is_null(old('order_frequency')) ? 'selected' : '' }}>Select Order
                                                    Frequency</option>
                                                <option value="1"
                                                    {{ old('order_frequency') == '1' ? 'selected' : '' }}>Every week
                                                </option>
                                                <option value="2"
                                                    {{ old('order_frequency') == '2' ? 'selected' : '' }}>After 2 weeks
                                                </option>
                                                <option value="3"
                                                    {{ old('order_frequency') == '3' ? 'selected' : '' }}>After 3 weeks
                                                </option>
                                                <option value="4"
                                                    {{ old('order_frequency') == '4' ? 'selected' : '' }}>After 4 weeks
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                        <div class="form-group mb-2">
                                            ...
                                            <select class="form-control date-dropdown" name="order_days">
                                                <option value="" disabled
                                                    {{ is_null(old('order_days')) ? 'selected' : '' }}>Select Days</option>
                                                @php
                                                    $daysOfWeek = [
                                                        'Monday',
                                                        'Tuesday',
                                    ...
                                    <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                        <div class="form-group mb-2">
                                            ...
                                            <select class="form-control" name="delivery_frequency">
                                                <option value="" disabled
                                                    {{ is_null(old('delivery_frequency')) ? 'selected' : '' }}>Select
                                                    Delivery Frequency</option>
                                                <option value="1"
                                                    {{ old('delivery_frequency') == '1' ? 'selected' : '' }}>Every week
                                                </option>
                                                <option value="2"
                                                    {{ old('delivery_frequency') == '2' ? 'selected' : '' }}>After 2 weeks
                                                </option>
                                                <option value="3"
                                                    {{ old('delivery_frequency') == '3' ? 'selected' : '' }}>After 3 weeks
                                                </option>
                                                <option value="4"
                                                    {{ old('delivery_frequency') == '4' ? 'selected' : '' }}>After 4 weeks
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                        <div class="form-group mb-2">
                                            ...
                                            <select class="form-control date-dropdown" name="delivery_days">
                                                <option value="" disabled
                                                    {{ is_null(old('delivery_days')) ? 'selected' : '' }}>Select Days
                                                </option>
                                                @foreach ($daysOfWeek as $day)
                                                    <option value="{{ $day }}"
                                                        {{ old('delivery_days') == $day ? 'selected' : '' }}>
                                                        {{ $day }}</option>
                                                @endforeach
                                            </select>
                                            @error('delivery_days')
                                    ...
                                    {{-- <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                        <div class="form-group mb-2">
                                            <label>Salesman Name<span class="text-danger">*</span></label>
                                            <input type="salesman_name" placeholder="Enter Salesman Name"
                                    ...
                                    {{-- <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="tel" placeholder="Enter Salesman Phone No"
                                                ...
                                                value="{{ old('salesman_phone_number') }}" class="form-control">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            phoneInput.addEventListener('input', function() {
                var value = phoneInput.value.replace(/\D/g, ''); // Remove non-digit characters
                var x = value.match(/(\d{1})(\d{0,3})(\d{0,3})(\d{0,4})/);

                if (x) {
                    phoneInput.value = '+1 ' + x[2] + (x[3] ? ' ' + x[3] : '') + (x[4] ? ' ' + x[4] : '');
                }
            });

            phoneInput.addEventListener('paste', function(e) {
                e.preventDefault();
                var pastedData = e.clipboardData.getData('Text').replace(/\D/g, ''); // Get digits only
                if (pastedData.startsWith('1')) {
                    pastedData = pastedData.slice(1); // Remove leading 1 if already present
                }
                var x = pastedData.match(/(\d{3})(\d{3})(\d{4})/);
                phoneInput.value = x ? '+1 ' + x[1] + ' ' + x[2] + ' ' + x[3] : '';
            });
        });
    </script>
