        ...
        <section class="section">
            <div class="section-body">
                ...
                <form id="edit_department"
                    action="{{ route('manager.ProductsDepartments-update', ['id' => $id, 'departmentId' => $departmentId]) }}"
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                <h4 class="text-center my-4">Edit Assigned Department For ({{ $product->product_name }})</h4>
                                            ...
                                            <select class="form-control department-dropdown" name="department_id">
                                                ...
                                                @foreach ($specificStoreDepartments as $department)
                                                    <option value="{{ $department->id }}"
                                                        {{ isset($departments->department_id) && $departments->department_id == $department->id ? 'selected' : '' }}>
