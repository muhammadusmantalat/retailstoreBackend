...
class ProductImageController extends Controller
{
    public function index($id)
    {
        ...
        return view('managers.productImage.index', compact('productImages','id','product'));
    }
    ...
    public function create($id)
    {
        ...
        return view('managers.productImage.create', compact('product'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manager.storeManagerProductsImages', ['id' => $request->product_id])->with(['status' => true, 'message' => 'Product Image Added Successfully']);
    ...
    public function edit ($id)
    {
        ...
        return view('managers.productImage.edit', compact('productImage'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('manager.storeManagerProductsImages', ['id' => $productImage->product_id])->with(['status' => true, 'message' => 'Product Image Updated Successfully']);
    }
    ...
    public function destory($productId, $imageId)
    {
        ...
        return redirect()->route('manager.storeManagerProductsImages', ['id' => $productId])->with(['status' => true, 'message' => 'Product Image Deleted Successfully']);
    }
